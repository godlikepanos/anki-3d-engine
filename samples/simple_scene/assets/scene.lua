...
node = scene:newModelNode("column.003")
node:getSceneNodeBase():getModelComponent():loadModelResource("assets/column_walls.ankimdl")
trf = Transform.new()
...
node = scene:newModelNode("column.002")
node:getSceneNodeBase():getModelComponent():loadModelResource("assets/column_walls.ankimdl")
trf = Transform.new()
...
node = scene:newModelNode("column.001")
node:getSceneNodeBase():getModelComponent():loadModelResource("assets/column_walls.ankimdl")
trf = Transform.new()
...
node = scene:newModelNode("column")
node:getSceneNodeBase():getModelComponent():loadModelResource("assets/column_walls.ankimdl")
trf = Transform.new()
...
node:getSceneNodeBase():getModelComponent():loadModelResource("assets/room_walls.ankimdl")
trf = Transform.new()
