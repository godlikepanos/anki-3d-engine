...
struct ImGuiContext
{
    ...
    ImVector<const ImFont*> FontStack;                          // Stack for PushFont()/PopFont()
...
namespace ImGui
{
    ...
    inline const ImFont*    GetDefaultFont() { ImGuiContext& g = *GImGui; return g.IO.FontDefault ? g.IO.FontDefault : g.IO.Fonts->Fonts[0]; }
