...
static inline int pwrapEventManagernewSceneAmbientColorEvent(lua_State* l)
{
	...
	// Call the method
	SceneAmbientColorEvent* ret =
		self->newEvent<SceneAmbientColorEvent>(arg0, arg1, arg2);
	...
	ud->initPointed(
		-2736282921550252951, const_cast<SceneAmbientColorEvent*>(ret));
...
static inline void wrapEventManager(lua_State* l)
{
	...
	LuaBinder::pushLuaCFuncMethod(l,
		"newSceneAmbientColorEvent",
		wrapEventManagernewSceneAmbientColorEvent);
	LuaBinder::pushLuaCFuncMethod(
