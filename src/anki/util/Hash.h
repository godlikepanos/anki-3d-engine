...
/// @return The hash.
ANKI_USE_RESULT U64 computeHash(const void* buffer, U32 bufferSize, U64 seed = 123);
...
/// @return The new hash.
ANKI_USE_RESULT U64 appendHash(const void* buffer, U32 bufferSize, U64 prevHash);
/// @}
