...
LuaUserDataTypeInfo g_luaUserDataTypeInfoLightComponentType = {7936430221319761769, "LightComponentType", 0, nullptr, nullptr};
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoBodyComponentCollisionShapeType = {-5059214739204380300, "BodyComponentCollisionShapeType", 0, nullptr,
																			nullptr};
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoJointComponentyType = {-604151580415835659, "JointComponentyType", 0, nullptr, nullptr};
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoParticleGeometryType = {-777863949358632498, "ParticleGeometryType", 0, nullptr, nullptr};
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoSkyboxComponentType = {6786312660680915441, "SkyboxComponentType", 0, nullptr, nullptr};

template<>
const LuaUserDataTypeInfo& LuaUserData::getDataTypeInfoFor<SkyboxComponentType>()
{
	return g_luaUserDataTypeInfoSkyboxComponentType;
}

// Wrap enum SkyboxComponentType.
static inline void wrapSkyboxComponentType(lua_State* l)
{
	lua_newtable(l);
	lua_setglobal(l, g_luaUserDataTypeInfoSkyboxComponentType.m_typeName);
	lua_getglobal(l, g_luaUserDataTypeInfoSkyboxComponentType.m_typeName);

	lua_pushstring(l, "kSolidColor");
	ANKI_ASSERT(SkyboxComponentType(lua_Number(SkyboxComponentType::kSolidColor)) == SkyboxComponentType::kSolidColor
				&& "Can't map the enumerant to a lua_Number");
	lua_pushnumber(l, lua_Number(SkyboxComponentType::kSolidColor));
	lua_settable(l, -3);

	lua_pushstring(l, "kImage2D");
	ANKI_ASSERT(SkyboxComponentType(lua_Number(SkyboxComponentType::kImage2D)) == SkyboxComponentType::kImage2D
				&& "Can't map the enumerant to a lua_Number");
	lua_pushnumber(l, lua_Number(SkyboxComponentType::kImage2D));
	lua_settable(l, -3);

	lua_pushstring(l, "kGenerated");
	ANKI_ASSERT(SkyboxComponentType(lua_Number(SkyboxComponentType::kGenerated)) == SkyboxComponentType::kGenerated
				&& "Can't map the enumerant to a lua_Number");
	lua_pushnumber(l, lua_Number(SkyboxComponentType::kGenerated));
	lua_settable(l, -3);

	lua_settop(l, 0);
}

LuaUserDataTypeInfo g_luaUserDataTypeInfoMeshComponentType = {6560005582747508938, "MeshComponentType", 0, nullptr, nullptr};

template<>
const LuaUserDataTypeInfo& LuaUserData::getDataTypeInfoFor<MeshComponentType>()
{
	return g_luaUserDataTypeInfoMeshComponentType;
}

// Wrap enum MeshComponentType.
static inline void wrapMeshComponentType(lua_State* l)
{
	lua_newtable(l);
	lua_setglobal(l, g_luaUserDataTypeInfoMeshComponentType.m_typeName);
	lua_getglobal(l, g_luaUserDataTypeInfoMeshComponentType.m_typeName);

	lua_pushstring(l, "kMeshResource");
	ANKI_ASSERT(MeshComponentType(lua_Number(MeshComponentType::kMeshResource)) == MeshComponentType::kMeshResource
				&& "Can't map the enumerant to a lua_Number");
	lua_pushnumber(l, lua_Number(MeshComponentType::kMeshResource));
	lua_settable(l, -3);

	lua_pushstring(l, "kPrimitive");
	ANKI_ASSERT(MeshComponentType(lua_Number(MeshComponentType::kPrimitive)) == MeshComponentType::kPrimitive
				&& "Can't map the enumerant to a lua_Number");
	lua_pushnumber(l, lua_Number(MeshComponentType::kPrimitive));
	lua_settable(l, -3);

	lua_settop(l, 0);
}

LuaUserDataTypeInfo g_luaUserDataTypeInfoMeshComponentPrimitiveType = {-4443164545362986122, "MeshComponentPrimitiveType", 0, nullptr, nullptr};

template<>
const LuaUserDataTypeInfo& LuaUserData::getDataTypeInfoFor<MeshComponentPrimitiveType>()
{
	return g_luaUserDataTypeInfoMeshComponentPrimitiveType;
}

// Wrap enum MeshComponentPrimitiveType.
static inline void wrapMeshComponentPrimitiveType(lua_State* l)
{
	lua_newtable(l);
	lua_setglobal(l, g_luaUserDataTypeInfoMeshComponentPrimitiveType.m_typeName);
	lua_getglobal(l, g_luaUserDataTypeInfoMeshComponentPrimitiveType.m_typeName);

	lua_pushstring(l, "kBox");
	ANKI_ASSERT(MeshComponentPrimitiveType(lua_Number(MeshComponentPrimitiveType::kBox)) == MeshComponentPrimitiveType::kBox
				&& "Can't map the enumerant to a lua_Number");
	lua_pushnumber(l, lua_Number(MeshComponentPrimitiveType::kBox));
	lua_settable(l, -3);

	lua_pushstring(l, "kSphere");
	ANKI_ASSERT(MeshComponentPrimitiveType(lua_Number(MeshComponentPrimitiveType::kSphere)) == MeshComponentPrimitiveType::kSphere
				&& "Can't map the enumerant to a lua_Number");
	lua_pushnumber(l, lua_Number(MeshComponentPrimitiveType::kSphere));
	lua_settable(l, -3);

	lua_settop(l, 0);
}

LuaUserDataTypeInfo g_luaUserDataTypeInfoReparentFlag = {1297786023603316919, "ReparentFlag", 0, nullptr, nullptr};

template<>
const LuaUserDataTypeInfo& LuaUserData::getDataTypeInfoFor<ReparentFlag>()
{
	return g_luaUserDataTypeInfoReparentFlag;
}

// Wrap enum ReparentFlag.
static inline void wrapReparentFlag(lua_State* l)
{
	lua_newtable(l);
	lua_setglobal(l, g_luaUserDataTypeInfoReparentFlag.m_typeName);
	lua_getglobal(l, g_luaUserDataTypeInfoReparentFlag.m_typeName);

	lua_pushstring(l, "kNone");
	ANKI_ASSERT(ReparentFlag(lua_Number(ReparentFlag::kNone)) == ReparentFlag::kNone && "Can't map the enumerant to a lua_Number");
	lua_pushnumber(l, lua_Number(ReparentFlag::kNone));
	lua_settable(l, -3);

	lua_pushstring(l, "kKeepWorldTransform");
	ANKI_ASSERT(ReparentFlag(lua_Number(ReparentFlag::kKeepWorldTransform)) == ReparentFlag::kKeepWorldTransform
				&& "Can't map the enumerant to a lua_Number");
	lua_pushnumber(l, lua_Number(ReparentFlag::kKeepWorldTransform));
	lua_settable(l, -3);

	lua_settop(l, 0);
}

LuaUserDataTypeInfo g_luaUserDataTypeInfoTriggerComponentShapeType = {2560584507465660283, "TriggerComponentShapeType", 0, nullptr, nullptr};

template<>
const LuaUserDataTypeInfo& LuaUserData::getDataTypeInfoFor<TriggerComponentShapeType>()
{
	return g_luaUserDataTypeInfoTriggerComponentShapeType;
}

// Wrap enum TriggerComponentShapeType.
static inline void wrapTriggerComponentShapeType(lua_State* l)
{
	lua_newtable(l);
	lua_setglobal(l, g_luaUserDataTypeInfoTriggerComponentShapeType.m_typeName);
	lua_getglobal(l, g_luaUserDataTypeInfoTriggerComponentShapeType.m_typeName);

	lua_pushstring(l, "kSphere");
	ANKI_ASSERT(TriggerComponentShapeType(lua_Number(TriggerComponentShapeType::kSphere)) == TriggerComponentShapeType::kSphere
				&& "Can't map the enumerant to a lua_Number");
	lua_pushnumber(l, lua_Number(TriggerComponentShapeType::kSphere));
	lua_settable(l, -3);

	lua_pushstring(l, "kBox");
	ANKI_ASSERT(TriggerComponentShapeType(lua_Number(TriggerComponentShapeType::kBox)) == TriggerComponentShapeType::kBox
				&& "Can't map the enumerant to a lua_Number");
	lua_pushnumber(l, lua_Number(TriggerComponentShapeType::kBox));
	lua_settable(l, -3);

	lua_pushstring(l, "kCount");
	ANKI_ASSERT(TriggerComponentShapeType(lua_Number(TriggerComponentShapeType::kCount)) == TriggerComponentShapeType::kCount
				&& "Can't map the enumerant to a lua_Number");
	lua_pushnumber(l, lua_Number(TriggerComponentShapeType::kCount));
	lua_settable(l, -3);
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoWeakArraySceneNodePtr = {
	5983299823991580991, "WeakArraySceneNodePtr", LuaUserData::computeSizeForGarbageCollected<WeakArraySceneNodePtr>(), nullptr, nullptr};
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoSceneComponentUpdateInfo = {
	968098486920255238, "SceneComponentUpdateInfo", LuaUserData::computeSizeForGarbageCollected<SceneComponentUpdateInfo>(), nullptr, nullptr};
...
static inline int wrapSceneComponentUpdateInfogetSceneNode(lua_State* l)
{
	...
	// Get "this" as "self"
	if(LuaBinder::checkUserData(l, ANKI_FILE, __LINE__, ANKI_FUNC, 1, g_luaUserDataTypeInfoSceneComponentUpdateInfo, ud)) [[unlikely]]
	{
		return lua_error(l);
	}

	SceneComponentUpdateInfo* self = ud->getData<SceneComponentUpdateInfo>();

	// Call the method
	SceneNode& ret = self->getSceneNode();
...
// Wrap class SceneComponentUpdateInfo.
static inline void wrapSceneComponentUpdateInfo(lua_State* l)
{
	LuaBinder::createClass(l, &g_luaUserDataTypeInfoSceneComponentUpdateInfo);
	LuaBinder::pushLuaCFuncMethod(l, "getSceneNode", wrapSceneComponentUpdateInfogetSceneNode);
	LuaBinder::pushLuaCFuncMethod(l, "getDt", wrapSceneComponentUpdateInfogetDt);
	LuaBinder::pushLuaCFuncMethod(l, "getPreviousTime", wrapSceneComponentUpdateInfogetPreviousTime);
	LuaBinder::pushLuaCFuncMethod(l, "getCurrentTime", wrapSceneComponentUpdateInfogetCurrentTime);
	lua_settop(l, 0);
}

LuaUserDataTypeInfo g_luaUserDataTypeInfoLightComponent = {8010434453258694059, "LightComponent",
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoDecalComponent = {8920097863265451072, "DecalComponent",
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoLensFlareComponent = {5048593128880219173, "LensFlareComponent",
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoBodyComponent = {-8229290280332013596, "BodyComponent",
...
static inline int wrapBodyComponentsetCollisionShapeType(lua_State* l)
{
	...
	// Call the method
	BodyComponent& ret = self->setCollisionShapeType(arg0);
...
static inline int wrapBodyComponentgetCollisionShapeType(lua_State* l)
{
	...
	// Call the method
	BodyComponentCollisionShapeType ret = self->getCollisionShapeType();

	// Push return value
	size = LuaUserData::computeSizeForGarbageCollected<BodyComponentCollisionShapeType>();
	voidp = lua_newuserdata(l, size);
	luaL_setmetatable(l, "BodyComponentCollisionShapeType");
	ud = static_cast<LuaUserData*>(voidp);
	extern LuaUserDataTypeInfo g_luaUserDataTypeInfoBodyComponentCollisionShapeType;
	ud->initGarbageCollected(&g_luaUserDataTypeInfoBodyComponentCollisionShapeType);
	::new(ud->getData<BodyComponentCollisionShapeType>()) BodyComponentCollisionShapeType(std::move(ret));
...
static inline int wrapBodyComponentsetBoxExtend(lua_State* l)
{
	...
	// Call the method
	BodyComponent& ret = self->setBoxExtend(arg0);
...
static inline int wrapBodyComponentsetSphereRadius(lua_State* l)
{
	...
	// Call the method
	BodyComponent& ret = self->setSphereRadius(arg0);
...
static inline int wrapBodyComponentsetMass(lua_State* l)
{
	...
	// Call the method
	BodyComponent& ret = self->setMass(arg0);
...
static inline void wrapBodyComponent(lua_State* l)
{
	...
	LuaBinder::pushLuaCFuncMethod(l, "getCollisionShapeType", wrapBodyComponentgetCollisionShapeType);
	...
	LuaBinder::pushLuaCFuncMethod(l, "setMass", wrapBodyComponentsetMass);
	LuaBinder::pushLuaCFuncMethod(l, "getMass", wrapBodyComponentgetMass);
	LuaBinder::pushLuaCFuncMethod(l, "applyForce", wrapBodyComponentapplyForce);
	LuaBinder::pushLuaCFuncMethod(l, "isValid", wrapBodyComponentisValid);
	lua_settop(l, 0);
}

LuaUserDataTypeInfo g_luaUserDataTypeInfoJointComponent = {-184410022180487534, "JointComponent",
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoTriggerComponent = {-1968296150688224261, "TriggerComponent",
...
static inline int wrapTriggerComponentsetTriggerComponentType(lua_State* l)
{
	...
	const TriggerComponentShapeType arg0 = TriggerComponentShapeType(arg0Tmp);

	// Call the method
	TriggerComponent& ret = self->setTriggerComponentType(arg0);
...
static inline int wrapTriggerComponentgetTriggerComponentType(lua_State* l)
{
	...
	// Call the method
	TriggerComponentShapeType ret = self->getTriggerComponentType();

	// Push return value
	size = LuaUserData::computeSizeForGarbageCollected<TriggerComponentShapeType>();
	voidp = lua_newuserdata(l, size);
	luaL_setmetatable(l, "TriggerComponentShapeType");
	ud = static_cast<LuaUserData*>(voidp);
	extern LuaUserDataTypeInfo g_luaUserDataTypeInfoTriggerComponentShapeType;
	ud->initGarbageCollected(&g_luaUserDataTypeInfoTriggerComponentShapeType);
	::new(ud->getData<TriggerComponentShapeType>()) TriggerComponentShapeType(std::move(ret));
...
static inline void wrapTriggerComponent(lua_State* l)
{
	...
	LuaBinder::pushLuaCFuncMethod(l, "setTriggerComponentType", wrapTriggerComponentsetTriggerComponentType);
	LuaBinder::pushLuaCFuncMethod(l, "getTriggerComponentType", wrapTriggerComponentgetTriggerComponentType);
	lua_settop(l, 0);
}

LuaUserDataTypeInfo g_luaUserDataTypeInfoFogDensityComponent = {3729169794712819351, "FogDensityComponent",
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoCameraComponent = {-6684915005028676994, "CameraComponent",
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoGlobalIlluminationProbeComponent = {
	7552124987916209434, "GlobalIlluminationProbeComponent", LuaUserData::computeSizeForGarbageCollected<GlobalIlluminationProbeComponent>(), nullptr,
	nullptr};
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoReflectionProbeComponent = {
	9078458500280990188, "ReflectionProbeComponent", LuaUserData::computeSizeForGarbageCollected<ReflectionProbeComponent>(), nullptr, nullptr};
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoParticleEmitter2Component = {
	8418247143492993259, "ParticleEmitter2Component", LuaUserData::computeSizeForGarbageCollected<ParticleEmitter2Component>(), nullptr, nullptr};
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoMeshComponent = {-3385910953713384786, "MeshComponent",
...
static inline int wrapMeshComponentsetMeshComponentType(lua_State* l)
{
	...
	const MeshComponentType arg0 = MeshComponentType(arg0Tmp);

	// Call the method
	MeshComponent& ret = self->setMeshComponentType(arg0);
...
static inline int wrapMeshComponentsetMeshComponentPrimitiveType(lua_State* l)
{
	...
	const MeshComponentPrimitiveType arg0 = MeshComponentPrimitiveType(arg0Tmp);

	// Call the method
	MeshComponent& ret = self->setMeshComponentPrimitiveType(arg0);
...
static inline int wrapMeshComponentsetSpherePrimitiveSubdivision(lua_State* l)
{
	...
	// Call the method
	MeshComponent& ret = self->setSpherePrimitiveSubdivision(arg0);
...
static inline void wrapMeshComponent(lua_State* l)
{
	...
	LuaBinder::pushLuaCFuncMethod(l, "setMeshComponentType", wrapMeshComponentsetMeshComponentType);
	LuaBinder::pushLuaCFuncMethod(l, "setMeshComponentPrimitiveType", wrapMeshComponentsetMeshComponentPrimitiveType);
	LuaBinder::pushLuaCFuncMethod(l, "setSpherePrimitiveSubdivision", wrapMeshComponentsetSpherePrimitiveSubdivision);
	LuaBinder::pushLuaCFuncMethod(l, "setMeshFilename", wrapMeshComponentsetMeshFilename);
	lua_settop(l, 0);
}

LuaUserDataTypeInfo g_luaUserDataTypeInfoMaterialComponent = {-1748984446333211118, "MaterialComponent",
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoSkinComponent = {-8660601458924056287, "SkinComponent",
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoSkyboxComponent = {7377830434087374877, "SkyboxComponent",
...
static inline int wrapSkyboxComponentsetSkyboxComponentType(lua_State* l)
{
	...
	const SkyboxComponentType arg0 = SkyboxComponentType(arg0Tmp);

	// Call the method
	SkyboxComponent& ret = self->setSkyboxComponentType(arg0);
...
static inline int wrapSkyboxComponentgetSkyboxComponentType(lua_State* l)
{
	...
	// Call the method
	SkyboxComponentType ret = self->getSkyboxComponentType();

	// Push return value
	size = LuaUserData::computeSizeForGarbageCollected<SkyboxComponentType>();
	voidp = lua_newuserdata(l, size);
	luaL_setmetatable(l, "SkyboxComponentType");
	ud = static_cast<LuaUserData*>(voidp);
	extern LuaUserDataTypeInfo g_luaUserDataTypeInfoSkyboxComponentType;
	ud->initGarbageCollected(&g_luaUserDataTypeInfoSkyboxComponentType);
	::new(ud->getData<SkyboxComponentType>()) SkyboxComponentType(std::move(ret));
...
static inline int wrapSkyboxComponentsetSkySolidColor(lua_State* l)
{
	...
	// Call the method
	SkyboxComponent& ret = self->setSkySolidColor(arg0);
...
static inline int wrapSkyboxComponentgetSkySolidColor(lua_State* l)
{
	...
	// Call the method
	Vec3 ret = self->getSkySolidColor();
...
static inline int wrapSkyboxComponentsetSkyImageFilename(lua_State* l)
{
	...
	// Call the method
	SkyboxComponent& ret = self->setSkyImageFilename(arg0);
...
static inline int wrapSkyboxComponentsetSkyImageColorBias(lua_State* l)
{
	...
	// Call the method
	SkyboxComponent& ret = self->setSkyImageColorBias(arg0);
...
static inline int wrapSkyboxComponentsetSkyImageColorScale(lua_State* l)
{
	...
	// Call the method
	SkyboxComponent& ret = self->setSkyImageColorScale(arg0);
...
static inline int wrapSkyboxComponentsetMinFogDensity(lua_State* l)
{
	...
	// Call the method
	SkyboxComponent& ret = self->setMinFogDensity(arg0);
...
static inline int wrapSkyboxComponentsetMaxFogDensity(lua_State* l)
{
	...
	// Call the method
	SkyboxComponent& ret = self->setMaxFogDensity(arg0);
...
static inline int wrapSkyboxComponentsetHeightOfMinFogDensity(lua_State* l)
{
	...
	// Call the method
	SkyboxComponent& ret = self->setHeightOfMinFogDensity(arg0);
...
static inline int wrapSkyboxComponentsetHeightOfMaxFogDensity(lua_State* l)
{
	...
	// Call the method
	SkyboxComponent& ret = self->setHeightOfMaxFogDensity(arg0);
...
static inline int wrapSkyboxComponentsetFogDiffuseColor(lua_State* l)
{
	...
	// Call the method
	SkyboxComponent& ret = self->setFogDiffuseColor(arg0);
...
static inline void wrapSkyboxComponent(lua_State* l)
{
	...
	LuaBinder::pushLuaCFuncMethod(l, "setSkyboxComponentType", wrapSkyboxComponentsetSkyboxComponentType);
	LuaBinder::pushLuaCFuncMethod(l, "getSkyboxComponentType", wrapSkyboxComponentgetSkyboxComponentType);
	LuaBinder::pushLuaCFuncMethod(l, "setSkySolidColor", wrapSkyboxComponentsetSkySolidColor);
	LuaBinder::pushLuaCFuncMethod(l, "getSkySolidColor", wrapSkyboxComponentgetSkySolidColor);
	LuaBinder::pushLuaCFuncMethod(l, "setSkyImageFilename", wrapSkyboxComponentsetSkyImageFilename);
	LuaBinder::pushLuaCFuncMethod(l, "setSkyImageColorBias", wrapSkyboxComponentsetSkyImageColorBias);
	LuaBinder::pushLuaCFuncMethod(l, "setSkyImageColorScale", wrapSkyboxComponentsetSkyImageColorScale);
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoSceneNode = {-3107662772420155490, "SceneNode", LuaUserData::computeSizeForGarbageCollected<SceneNode>(),
													  nullptr, nullptr};
...
static inline int wrapSceneNodesetParent(lua_State* l)
{
	...
	const ReparentFlag arg1 = ReparentFlag(arg1Tmp);
...
static inline void wrapSceneNode(lua_State* l)
{
	...
	LuaBinder::pushLuaCFuncMethod(l, "setParent", wrapSceneNodesetParent);
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoSceneGraph = {-5090414942894446784, "SceneGraph", LuaUserData::computeSizeForGarbageCollected<SceneGraph>(),
													   nullptr, nullptr};
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoEvent = {7858036410789432974, "Event", LuaUserData::computeSizeForGarbageCollected<Event>(), nullptr,
												  nullptr};
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoLightEvent = {4464285344918332431, "LightEvent", LuaUserData::computeSizeForGarbageCollected<LightEvent>(),
													   nullptr, nullptr};
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoScriptEvent = {-6316513919011025069, "ScriptEvent",
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoJitterMoveEvent = {-6683184108780542307, "JitterMoveEvent",
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoAnimationEvent = {7014754217239964363, "AnimationEvent",
...
LuaUserDataTypeInfo g_luaUserDataTypeInfoEventManager = {-8528387099708402714, "EventManager",
...
void wrapModuleScene(lua_State* l)
{
	...
	wrapSceneComponentUpdateInfo(l);
