...
// It provides the tools to build allocators based on segregated lists and best fit.
// TChunk: A user defined class that contains a memory chunk. It should inherit from SegregatedListsAllocatorBuilderChunkBase.
// TInterface: The interface that contains the following members:
//     // The number of classes
//     U32 getClassCount() const;
//     // Max size for each class.
//     void getClassInfo(U32 idx, PtrSize& size) const;
//     // Allocates a new user defined chunk of memory. The interface controls the chunk size
...
// TLock: User defined lock (eg Mutex).
...
public:
	...
	// alignment: The alignment of the returned address. No need to be power of 2.
